 ...
 */
type VaultInformationCardProps = {
    address: string;
};

/**
 * VaultInformationCard is just yet another react component
 *
 * @link https://fettblog.eu/typescript-react/components/#functional-components
 */
const VaultInformationCard: FunctionComponent<VaultInformationCardProps> = ({ address }) => {
...
export default VaultInformationCard;
