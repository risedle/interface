...
/**
 * ButtonFetchingOnchainDataProps is a React Component properties that passed to React Component ButtonFetchingOnchainData
 */
type ButtonFetchingOnchainDataProps = {};

/**
 * ButtonFetchingOnchainData is just yet another react component
 *
 * @link https://fettblog.eu/typescript-react/components/#functional-components
 */
const ButtonFetchingOnchainData: FunctionComponent<ButtonFetchingOnchainDataProps> = ({}) => {
    return (
        <button className="inline-block flex w-full cursor-wait flex-row justify-center space-x-2 rounded-full border border-gray-light-4 bg-gray-light-2 py-[11px] px-4 text-center text-sm font-semibold leading-4 leading-4 tracking-[-0.02em] text-blue-dark-1 drop-shadow-[0_0_45px_rgba(54,158,255,0.1)] dark:border-gray-dark-4 dark:bg-gray-dark-2 dark:text-blue-light-1">
            ...
            <div>Fetching onchain data...</div>
        </button>
    );
};

export default ButtonFetchingOnchainData;
