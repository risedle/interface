 ...
 */
 ...
 const MarketDetailPage: FunctionComponent<MarketDetailPageProps> = ({
     title,
     path
 }) => {
    return(
        <>
            ...
            <meta property="og:image" content={`http://localhost:3000/${title}.png`}/>
            ...
            <meta name="twitter:image" content={`http://localhost:3000/${title}.png`}/>
        </>
    )
 }
