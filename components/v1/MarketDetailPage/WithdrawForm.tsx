...
import { WithdrawState, RequestState } from "./States";
    ...
    return (
        <div className="mt-6">
            <div className="flex flex-row justify-between items-center">
                <p className="text-xs leading-4 font-semibold text-gray-light-12 dark:text-gray-dark-12">How many {metadata.vaultTitle}?</p>
            </div>
            <form className="flex flex-col mt-2 space-y-4">
                <div className="flex flex-row p-4 bg-gray-light-3 dark:bg-gray-dark-3 rounded-[8px] items-center justify-between">
                    ...
                    <div className="grow">
                        <input
                            ...
                            value={withdrawState.amount ? withdrawState.amount.toString() : 0}
                            step={0.001}
                            onChange={(e) => {
                                if (e.target.value === "") {
                                ...
                                setWithdrawState({ ...withdrawState, amount: value });
                            }}
                        />
                    </div>
                    ...
                    <div className="flex-none">
                        <button
                            ...
                            onClick={(e) => {
                                e.preventDefault();
                                setWithdrawState({ ...withdrawState, amount: balance });
                            }}
                        >
                ...
                <div className="flex flex-row justify-between">
                    <p className="text-xs leading-4 text-gray-light-10 dark:text-gray-dark-10 text-left">
                        Balance: {balance.toFixed(3)} {metadata.vaultTitle}
                    </p>
                </div>
                ...
                <div className="pt-4 pb-8 border-b border-gray-light-5 dark:border-gray-dark-5 border-dashed">
                    ...
                    {showNormalSlider && (
                        <Slider.Root
                            min={0}
                            value={[withdrawState.amount ? withdrawState.amount : 0]}
                            max={parseFloat(balance.toFixed(3))}
                            step={0.01}
                            className="relative w-full flex flex-row items-center"
                            onValueChange={(value) => {
                                setWithdrawState({ ...withdrawState, amount: value[0] });
                            }}
                        >
                ...
                <div className="text-center">
                    <p className="text-xs leading-4 text-gray-light-10 dark:text-gray-dark-10">
                        ...
                        <span className="font-semibold text-gray-light-12 dark:text-gray-dark-12">
                            {withdrawAmount.toFixed(3)} {metadata.debtSymbol}
                        </span>
                    </p>
                </div>
                                ...
                                <button
                                    onClick={async (e) => {
                                        ...
                                        try {
                                            ...
                                            toast.custom((t) => (
                                                <ToastInProgress>
                                                    Withdrawing {withdrawAmount.toFixed(3)} {metadata.debtSymbol}
                                                </ToastInProgress>
                                            ));
                                            ...
                                            if (receipt.status === 1) {
                                                ...
                                                toast.custom((t) => (
                                                    <ToastSuccess>
                                                        Withdraw {withdrawAmount.toFixed()} {metadata.debtSymbol} is successful
                                                    </ToastSuccess>
                                                ));
                ...
                {withdrawState.hash && (
                    <div className="text-center">
                        <Link href={getExplorerLink(chain, withdrawState.hash)}>
