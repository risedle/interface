...
const ButtonDepositOrWithdraw: FunctionComponent<ButtonDepositOrWithdrawProps> = ({ address }) => {
    ...
    return (
        <Dialog.Root>
            ...
            <Dialog.Content className="fixed left-0 bottom-0 z-30 sm:flex sm:h-screen w-screen sm:items-center">
                {/* Mint or Redeem container */}
                <div className="mx-4 mx-auto mb-4 sm:flex-auto flex-col rounded-[24px] border border-gray-light-3 bg-gray-light-1 p-4 dark:border-gray-dark-3 dark:bg-gray-dark-1 sm:m-auto sm:max-w-[376px]">
