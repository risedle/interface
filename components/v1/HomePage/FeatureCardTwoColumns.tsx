                ...
                <div className="basis-1/2 bg-gray-light-2 dark:bg-gray-dark-2 border border-gray-light-3 dark:border-gray-dark-3 rounded-lg overflow-hidden flex flex-col mb-4 sm:mb-0 sm:mr-2">
                    <div className="px-4 sm:px-8 py-6 sm:basis-1/3">
                        ...
                        <p className="text-sm text-gray-light-10 dark:text-gray-dark-10 leading-6 mb-6">
                            Just like leveraging assets manually using lending
                            protocol, you will not get charged for management
                            fees.
                        </p>
                    ...
                    <div className="sm:basis-2/3 inline-block ">
                        ...
                        >
                            ...
                            />
                            <path
                                d="M362.5 195C362.5 302.421 275.642 389.5 168.5 389.5C61.358 389.5 -25.5 302.421 -25.5 195C-25.5 87.5794 61.358 0.5 168.5 0.5C275.642 0.5 362.5 87.5794 362.5 195Z"
                                className="stroke-gray-light-5 dark:stroke-gray-dark-5"
                            />
                            <circle
                                cx="168.5"
                            ...
                            <g filter="url(#filter0_f_479_19236)">
                                <rect
                                    ...
                                    width="22.1427"
                                    height="204.941"
                                    transform="rotate(-16.0921 -33 386.089)"
                                    fill="#5FD4F4"
                                />
                            </g>
                            <g filter="url(#filter1_f_479_19236)">
                                <rect
                                    ...
                                    width="22.1427"
                                    height="183.534"
                                    transform="rotate(-16.0921 147.807 323.045)"
                                    fill="#5EB0EF"
                                />
                            </g>
                            <g filter="url(#filter2_f_479_19236)">
                                <rect
                                    ...
                                    width="22.1427"
                                    height="183.534"
                                    transform="rotate(-16.0921 97.8477 323.045)"
                                    fill="#5EB0EF"
                                />
                            </g>
                            <g filter="url(#filter3_f_479_19236)">
                                <rect
                                    ...
                                    width="22.1427"
                                    height="183.534"
                                    transform="rotate(-16.0921 338.129 287.359)"
                                    fill="#5EB0EF"
                                />
                            </g>
                            <g filter="url(#filter4_f_479_19236)">
                                <rect
                                    ...
                                    width="22.1427"
                                    height="220.36"
                                    transform="rotate(-16.0921 208.473 362.299)"
                                    fill="#99D52A"
                                />
                            </g>
                            <g filter="url(#filter5_f_479_19236)">
                                <rect
                                    ...
                                    width="22.1427"
                                    height="220.36"
                                    transform="rotate(-16.0921 -17.5352 267.137)"
                                    fill="#99D52A"
                                />
                            </g>
                            <defs>
                                <filter
                                    id="filter0_f_479_19236"
                                    x="-188.623"
                                    y="224.329"
                                    width="389.326"
                                    height="514.294"
                                ...
                                >
                                    ...
                                    <feGaussianBlur
                                        ...
                                        result="effect1_foregroundBlur_479_19236"
                                    />
                                </filter>
                                <filter
                                    id="filter1_f_479_19236"
                                    x="-7.81627"
                                    y="161.285"
                                    width="383.392"
                                    height="493.726"
                        ...
                        >
                            <g clipPath="url(#clip0_479_19257)">
                                ...
                                <circle
                                    ...
                                    cy="157"
                                    r="31.5"
                                    fill="url(#paint0_radial_479_19257)"
                                />
                                <circle
                                    cx="185"
                                    cy="157"
                                    r="31.5"
                                    fill="url(#paint1_radial_479_19257)"
                                />
                                <circle
                                    cx="185"
                                    cy="157"
                                ...
                                <g clipPath="url(#clip1_479_19257)">
                                    ...
                                    />
                                    <path
                                        d="M184.998 170L193.597 157.889L184.998 162.966L176.404 157.889L184.998 170Z"
                                        fill="#171717"
                                    />
                                </g>
                                <g filter="url(#filter0_f_479_19257)">
                                    <rect
                                        ...
                                        width="22.1427"
                                        height="183.534"
                                        transform="rotate(-16.0921 -139.193 -71.9551)"
                                        fill="#FF8B3E"
                                    />
                                </g>
                                <g filter="url(#filter1_f_479_19257)">
                                    <rect
                                        ...
                                        width="22.1427"
                                        height="183.534"
                                        transform="rotate(-16.0921 -189.152 -71.9551)"
                                        fill="#FF8B3E"
                                    />
                                </g>
                                <g filter="url(#filter2_f_479_19257)">
                                    <rect
                                        ...
                                        width="22.1427"
                                        height="183.534"
                                        transform="rotate(-16.0921 51.1289 -107.641)"
                                        fill="#FF8B3E"
                                    />
                                </g>
                                <g filter="url(#filter3_f_479_19257)">
                                    <rect
                                        ...
                                        width="22.1427"
                                        height="220.36"
                                        transform="rotate(-16.0921 -78.5273 -32.7012)"
                                        fill="#D864D8"
                                    />
                                </g>
                            </g>
                            <defs>
                                ...
                                >
                                    ...
                                    <feGaussianBlur
                                        stdDeviation="77.8115"
                                        result="effect1_foregroundBlur_479_19257"
                                    />
                                </filter>
                                <filter
                                    id="filter1_f_479_19257"
                                    x="-344.775"
                                    y="-233.715"
                                    width="383.392"
                                    height="493.726"
