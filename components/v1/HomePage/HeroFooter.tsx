...
const HeroFooter: FunctionComponent<HeroFooterProps> = ({}) => {
    return (
        <div className="relative w-full flex justify-center items-center my-20 sm:my-40">
            ...
            <svg width="100%" height="100%" viewBox="0 0 375 463" fill="none" xmlns="http://www.w3.org/2000/svg" className="z-0 absolute top-0 left-1/2 -translate-x-1/2  fill-gray-light-12 dark:fill-white max-w-3xl scale-150">
