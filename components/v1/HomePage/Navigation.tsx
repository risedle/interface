                        ...
                        return(
                            <>
                                <Popover.Button ref={setReferenceElement1} className={`flex items-center text-sm ${open ? "text-gray-light-10 dark:text-gray-dark-10" : "text-gray-light-12 dark:text-gray-dark-12"} sm:self-center transition`}>
                                    Communities 
                                    <svg className={`${open ? "stroke-gray-light-10 dark:stroke-gray-dark-10" : "stroke-gray-light-12 dark:stroke-gray-dark-12"}`} xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                                        <path d="M6 9l6 6 6-6"/>
                                    </svg>
                                </Popover.Button>
                                <Transition
                                ...
                                >
                                    <Popover.Panel ref={setPopperElement2} style={popper2.styles.popper} {...popper2.attributes.popper} className="min-w-[161px] bg-gray-light-2 dark:bg-gray-dark-2 border border-gray-light-4 dark:border-gray-dark-4 flex flex-col p-[8px] rounded-[16px]">
                                        ...
                                        <a href="#" className="flex items-center text-sm p-[8px] rounded-[8px] text-gray-light-12 dark:text-gray-dark-12 hover:bg-gray-light-3 hover:dark:bg-gray-dark-3 transition">
                                            ...
                                            <svg width="15" height="16" viewBox="0 0 15 16" fill="none" xmlns="http://www.w3.org/2000/svg" className="fill-gray-light-12 dark:fill-gray-dark-12 inline-block">
                                                <path fill-rule="evenodd" clip-rule="evenodd" d="M7.50039 2.2999C4.35237 2.2999 1.80039 4.85188 1.80039 7.9999C1.80039 11.1479 4.35237 13.6999 7.50039 13.6999C10.6484 13.6999 13.2004 11.1479 13.2004 7.9999C13.2004 4.85188 10.6484 2.2999 7.50039 2.2999ZM0.900391 7.9999C0.900391 4.35482 3.85531 1.3999 7.50039 1.3999C11.1455 1.3999 14.1004 4.35482 14.1004 7.9999C14.1004 11.645 11.1455 14.5999 7.50039 14.5999C3.85531 14.5999 0.900391 11.645 0.900391 7.9999Z"/>
                                                <path fill-rule="evenodd" clip-rule="evenodd" d="M13.5004 8.39985H1.50037V7.59985H13.5004V8.39985Z"/>
                                                <path fill-rule="evenodd" clip-rule="evenodd" d="M7.10034 13.9999V1.99988H7.90034V13.9999H7.10034Z"/>
                                                <path fill-rule="evenodd" clip-rule="evenodd" d="M10.3754 7.99986C10.3754 5.82712 9.59407 3.67766 8.06226 2.25644L8.53836 1.74329C10.24 3.32206 11.0754 5.67261 11.0754 7.99986C11.0754 10.3271 10.24 12.6777 8.53836 14.2564L8.06226 13.7433C9.59407 12.3221 10.3754 10.1726 10.3754 7.99986Z"/>
                                                <path fill-rule="evenodd" clip-rule="evenodd" d="M4.00012 7.99988C4.00012 5.67599 4.80829 3.32666 6.45811 1.74707L6.9422 2.25269C5.45863 3.6731 4.70012 5.82377 4.70012 7.99988C4.70013 10.176 5.45865 12.3267 6.94222 13.7471L6.45812 14.2527C4.80831 12.6731 4.00013 10.3238 4.00012 7.99988Z"/>
