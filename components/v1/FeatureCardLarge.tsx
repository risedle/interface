...
/**
 * FeatureCardLargeProps is a React Component properties that passed to React Component FeatureCardLarge
 */
type FeatureCardLargeProps = {};

/**
 * FeatureCardLarge is just yet another react component
 *
 * @link https://fettblog.eu/typescript-react/components/#functional-components
 */
const FeatureCardLarge: FunctionComponent<FeatureCardLargeProps> = ({}) => {
    return (
        <div className="px-4 max-w-4xl m-auto">
            <div className="bg-gray-light-2 dark:bg-gray-dark-2 border border-gray-light-3 dark:border-gray-dark-3 rounded-lg overflow-hidden flex flex-col sm:flex-row sm:items-center sm:h-80">
                <div className="px-4 sm:pl-8 py-6 sm:basis-1/3">
                    <h1 className="m-0 text-base sm:text-lg font-bold mb-4 text-gray-light-12 dark:text-gray-dark-12">
                        Enjoy Leverage Without Liquidations
                    </h1>
                    <p className="text-sm text-gray-light-10 dark:text-gray-dark-10 leading-6 mb-6">
                        Risedle Leveraged Tokens allows its holder to enjoy
                        increased leverage without risk of liquidation
                    </p>
                    <p className="text-sm text-gray-light-12 dark:text-gray-dark-12 font-bold leading-6">
                        <Link href="https://docs.risedle.com/What-are-Risedle-Leveraged-Tokens-6ad87257157845e69aa7d11f87af99ec">
                            <a>Learn more about Leveraged Tokens</a>
                        </Link>
                    </p>
                </div>
                <div className="sm:basis-2/3 inline-block ">
                    <svg
                        ...
                        className="object-cover sm:-mt-16"
                    >
                        <line
                            x1="52.5"
                            y1="2.18557e-08"
                            x2="52.5"
                            y2="382"
                            className="stroke-gray-light-3 dark:stroke-gray-dark-3"
                        />
                        <line
                            x1="132.5"
                            y1="2.18557e-08"
                        ...
                        <g filter="url(#filter0_f_479_19186)">
                            <rect
                                ...
                                width="22.1427"
                                height="204.941"
                                transform="rotate(-16.0921 120 296.089)"
                                fill="#5FD4F4"
                            />
                        </g>
                        <g filter="url(#filter1_f_479_19186)">
                            <rect
                                ...
                                width="22.1427"
                                height="183.534"
                                transform="rotate(-16.0921 300.807 233.045)"
                                fill="#EC5E41"
                            />
                        </g>
                        <g filter="url(#filter2_f_479_19186)">
                            <rect
                                ...
                                width="22.1427"
                                height="183.534"
                                transform="rotate(-16.0921 250.848 233.045)"
                                fill="#EC5E41"
                            />
                        </g>
                        <g filter="url(#filter3_f_479_19186)">
                            <rect
                                ...
                                width="22.1427"
                                height="183.534"
                                transform="rotate(-16.0921 491.129 197.359)"
                                fill="#EC5E41"
                            />
                        </g>
                        <g filter="url(#filter4_f_479_19186)">
                            <rect
                                ...
                                width="22.1427"
                                height="220.36"
                                transform="rotate(-16.0921 361.473 272.299)"
                                fill="#E93D82"
                            />
                        </g>
                        <g filter="url(#filter5_f_479_19186)">
                            <rect
                                ...
                                width="22.1427"
                                height="220.36"
                                transform="rotate(-16.0921 135.465 177.138)"
                                fill="#E93D82"
                            />
                        </g>
                        <path
                        ...
                        <circle
                            ...
                            cy="190"
                            r="27.5"
                            fill="url(#paint0_radial_479_19186)"
                        />
                        <circle
                            cx="52"
                            cy="190"
                            r="27.5"
                            fill="url(#paint1_radial_479_19186)"
                        />
                        <circle
                            cx="52"
                            cy="190"
                            r="27.5"
                            className="stroke-gray-light-2 dark:stroke-gray-dark-2"
                        />
                        <g clipPath="url(#clip0_479_19186)">
                            <path
                                d="M51.9984 195.34L60.5922 190.26L51.9984 176L43.4043 190.26L51.9984 195.34Z"
                                className="fill-gray-light-12"
                            />
                            <path
                                d="M51.9984 204L60.5974 191.889L51.9984 196.966L43.4043 191.889L51.9984 204Z"
                                className="fill-gray-light-12"
                            />
                        </g>
                        ...
                        <circle
                            ...
                            cy="190"
                            r="27.5"
                            fill="url(#paint2_radial_479_19186)"
                        />
                        <circle
                            cx="292"
                            cy="190"
                            r="27.5"
                            fill="url(#paint3_radial_479_19186)"
                        />
                        <circle
                            cx="292"
                            cy="190"
                        ...
                        <defs>
                            ...
                            >
                                ...
                                />
                                <feGaussianBlur
                                    stdDeviation="77.8115"
                                    result="effect1_foregroundBlur_479_19186"
                                />
                            </filter>
                            <filter
                                id="filter1_f_479_19186"
                                x="145.184"
                                y="71.2843"
                                width="383.392"
                                height="493.726"
                            ...
                            >
                                ...
                                <stop offset="0.144436" stop-color="#FFDEFC" />
                                <stop offset="0.193304" stop-color="#FFFDEE" />
                                <stop offset="0.195836" stop-color="#FDF7DF" />
                                <stop offset="0.392662" stop-color="#FFF4FE" />
                                <stop offset="0.421805" stop-color="#FFDEFC" />
                                <stop offset="0.510216" stop-color="#BAF3FF" />
                                <stop offset="0.554709" stop-color="#E6FAFF" />
                                <stop offset="0.635733" stop-color="white" />
                            </radialGradient>
                            <radialGradient
