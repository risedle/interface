    ...
    return (
        <>
            <div className="relative flex h-full min-h-screen w-full flex-col overflow-hidden bg-gray-light-1 font-inter dark:bg-gray-dark-1">
                ...
                <div className="mx-auto mb-20 flex flex-grow flex-col px-4 outline-0 sm:z-10 sm:mt-10 sm:mb-0">
                    <div className="mx-auto flex w-full flex-col space-y-6 outline-0 lg:grid lg:grid-cols-2 lg:gap-[24px] lg:space-y-0">
