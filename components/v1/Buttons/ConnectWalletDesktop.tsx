    ...
    return (
        <>
            <Dialog.Root onOpenChange={(open) => setIsOpen(open)} open={isOpen}>
                ...
                <Dialog.Content className="translate() fixed top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2">
                    <div className="relative mx-auto flex w-[342px] max-w-sm flex-col rounded-[24px] border border-gray-light-3 bg-gray-light-1 dark:border-gray-dark-3 dark:bg-gray-dark-1">
                        <div className="m-0 flex flex-row items-center justify-between border-b border-dashed border-gray-light-3 px-4 py-4 dark:border-gray-dark-3">
            ...
            {showAccountData && account && (
                <Popover.Root>
                    <Popover.Trigger className="inline-block rounded-full border border-gray-light-4 bg-gray-light-2 py-[11px] px-4 text-sm font-semibold leading-4 tracking-tighter text-blue-dark-1 dark:border-gray-dark-4 dark:bg-gray-dark-2 dark:text-blue-light-1">
