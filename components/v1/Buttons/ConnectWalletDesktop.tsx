                ...
                <div className="flex items-center justify-center min-h-screen">
                    ...
                    <div className="flex flex-col relative bg-gray-light-1 dark:bg-gray-dark-1 border border-gray-light-3 dark:border-gray-dark-3 rounded-[24px] max-w-sm mx-auto w-[342px]">
                        <Dialog.Title className="flex flex-row items-center px-4 py-4 justify-between border-b border-gray-light-3 dark:border-gray-dark-3 border-dashed m-0">
                            <span className="grow text-center pl-[40px] text-base leading-none font-bold text-gray-light-12 dark:text-gray-dark-12">{isConnecting ? "Connecting..." : "Connect Wallet"}</span>
                            <ButtonClose
                                onClick={() => {
                                    setIsOpen(false);
                                }}
