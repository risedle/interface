...
const ButtonConnectWalletDesktop: FunctionComponent<ButtonConnectWalletDesktopProps> = ({}) => {
    ...
    return (
        <>
                ...
                <div className="flex items-center justify-center min-h-screen">
                    ...
                    <div className="flex flex-col relative bg-gray-light-1 dark:bg-gray-dark-1 border border-gray-light-3 dark:border-gray-dark-3 rounded-[24px] max-w-sm mx-auto w-[342px]">
                        ...
                        <div className="flex flex-col p-4 space-y-2">
                            <button
                                className="bg-orange-light-2 dark:bg-orange-dark-2 border border-orange-light-5 dark:border-orange-dark-5 rounded-[12px] py-[11px] px-[12px] text-left w-full m-0 flex flex-row items-center justify-between transition ease-in-out duration-300 focus:scale-95 hover:bg-orange-light-3 dark:hover:bg-orange-dark-3"
                                onClick={async () => {
                            ...
                            <button
                                className="bg-blue-light-2 dark:bg-blue-dark-2 border border-blue-light-5 dark:border-blue-dark-5 rounded-[12px] py-[11px] px-[12px] text-left w-full m-0 flex flex-row items-center justify-between transition ease-in-out duration-300 focus:scale-95 hover:bg-blue-light-3 dark:hover:bg-blue-dark-3"
                                onClick={async () => {
            ...
            {account && connectedChain.data && connectedChain.data.chain && connectedChain.data.chain.id === chain.id && (
                <Popover>
                    <Popover.Button ref={setReferenceElement1} className="bg-gray-light-2 dark:bg-gray-dark-2 border border-gray-light-4 dark:border-gray-dark-4 text-blue-dark-1 dark:text-blue-light-1 text-sm font-semibold py-[11px] px-4 rounded-full leading-4 inline-block tracking-tighter">
                    ...
                    <Popover.Panel ref={setPopperElement1} style={popper1.styles.popper} {...popper1.attributes.popper} className="bg-gray-light-2 dark:bg-gray-dark-2 border border-gray-light-4 dark:border-gray-dark-4 w-[241px] rounded-[16px] flex flex-col">
                        {({ close }) => {
                            return (
                                <>
