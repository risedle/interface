...
const ButtonLoading: FunctionComponent<ButtonLoadingProps> = ({
    ...
    return(
        <button className={`button bg-gray-light-4 dark:bg-gray-dark-4 border border-gray-light-5 dark:border-gray-dark-5 rounded-full text-sm leading-4 tracking-[-0.02em] text-gray-light-12 dark:text-gray-dark-12 font-semibold py-[12px] px-[24px] transition ease-out duration-300 cursor-wait drop-shadow-[0_0_45px_rgba(54,158,255,0.1)] ${full ? 'w-full' : ''}`}>
            <svg width="17" height="16" viewBox="0 0 17 16" className="fill-gray-light-12 dark:fill-gray-dark-12 animate-spin mr-[8px]" xmlns="http://www.w3.org/2000/svg">
