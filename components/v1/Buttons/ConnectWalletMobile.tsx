...
const ButtonConnectWalletMobile: FunctionComponent<ButtonConnectWalletMobileProps> = ({}) => {
    ...
    const renderContent = () => {
        switch (isOpen) {
                        ...
                        {!account ? (
                            <>
                                <div className="m-0 border-b border-dashed border-gray-light-3 py-2 pr-2 pl-[49px] text-center dark:border-gray-dark-3">
                                    ...
                                    <button className="float-right self-center rounded-full border border-gray-light-4 bg-gray-light-2 align-middle dark:border-gray-dark-4 dark:bg-gray-dark-2" onClick={() => setIsOpen("none")}>
            ...
            case "menu":
                return (
                    <div className="fixed bottom-16  right-4 flex min-w-[161px] flex-col rounded-[16px] border border-gray-light-4 bg-gray-light-2 p-4 dark:border-gray-dark-4 dark:bg-gray-dark-2">
            ...
            <Dialog.Root open={isOpen != "none"}>
                ...
                >
                    {isOpen === "menu" ? (
                        ...
                        <svg className="flex-shrink-0 fill-gray-light-12 dark:fill-gray-dark-12" width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                            <path fillRule="evenodd" clipRule="evenodd" d="M2 3.5C1.72386 3.5 1.5 3.72386 1.5 4C1.5 4.27614 1.72386 4.5 2 4.5H14C14.2761 4.5 14.5 4.27614 14.5 4C14.5 3.72386 14.2761 3.5 14 3.5H2ZM1.5 8C1.5 7.72386 1.72386 7.5 2 7.5H14C14.2761 7.5 14.5 7.72386 14.5 8C14.5 8.27614 14.2761 8.5 14 8.5H2C1.72386 8.5 1.5 8.27614 1.5 8ZM1.5 12C1.5 11.7239 1.72386 11.5 2 11.5H14C14.2761 11.5 14.5 11.7239 14.5 12C14.5 12.2761 14.2761 12.5 14 12.5H2C1.72386 12.5 1.5 12.2761 1.5 12Z" />
                        </svg>
                    )}
                </button>
