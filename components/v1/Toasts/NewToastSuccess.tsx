...
import { ToastOption, useToastStore } from "../../../store/ToastStore";
 ...
 */
function NewToastSuccess({ description, duration, id }: ToastOption) {
        ...
        <>
            ...
            >
                <div className="inline-block flex max-w-max flex-row items-center rounded-full border border-green-light-10 bg-green-light-9 py-[3px] pl-[4px] pr-4 dark:border-green-dark-5 dark:bg-green-dark-2">
                    ...
                    <span className="ml-2 inline-block text-xs font-semibold leading-4 text-green-light-1 dark:text-green-dark-12">{description}</span>
                </div>
            </Toast.Root>
        </>
    );
