...
const MarketCard: FunctionComponent<MarketCardProps> = ({ chainID, address, initialNAV, initialNAVChange, totalSupply }) => {
    ...
    return (
        <div className="flex flex-col bg-gray-light-1 dark:bg-gray-dark-1 border border-gray-light-3 dark:border-gray-dark-3 rounded-[24px]">
            {/* Title and metadata */}
            <div className="flex flex-row px-4 py-4 items-center justify-between">
                <div className="flex flex-row space-x-4 items-center">
                    <img src={logo} alt={title} />
                    <div className="flex flex-col space-y-1">
                        <h2 className="text-sm leading-4 traking-[-0.02em] font-bold text-gray-light-12 dark:text-gray-dark-12">{title}</h2>
            ...
            {showSkeleton && <div className="hidden sm:block h-[192px] bg-gray-light-3 dark:bg-gray-dark-3 animate-pulse"></div>}
            {showRealData && (
            ...
            {/* Description */}
            <div className="mx-4 py-4 border-b border-gray-light-3 dark:border-gray-dark-3 border-dashed">
                <p className="text-xs leading-4 text-gray-light-9 dark:text-gray-dark-9">{description}</p>
            </div>

            {/* Nav, Change and marketcap */}
            <div className="flex flex-row p-4">
                <div className="basis-1/3 flex flex-col text-left space-y-2">
                ...
                <div className="basis-1/3 flex flex-col text-center space-y-2">
                ...
                <div className="basis-1/3 flex flex-col text-right space-y-2">
