...
const Footer: FunctionComponent<FooterProps> = ({}) => {
    return (
        <div className="flex flex-col sm:flex-row w-full border-t border-gray-light-3 dark:border-gray-dark-3 py-4 gap-4">
            <div className="px-4 flex flex-col sm:flex-row sm:self-center gap-4 sm:items-center justify-center text-sm ">
                <Link href="/">
                    <a>
                        <span className="font-inter traking-tight text-gray-light-10 dark:text-gray-dark-10">Risedle Labs</span>
                    </a>
                </Link>
                <div className="flex gap-2 text-gray-light-12 dark:text-gray-dark-12 items-center">
