...
/**
 * ButtonThemeSwitcherTextProps is a React Component properties that passed to React Component ButtonThemeSwitcherText
 */
type ButtonThemeSwitcherTextProps = {};

/**
 * ButtonThemeSwitcherText is just yet another react component
 *
...
const ButtonThemeSwitcherText: FunctionComponent<ButtonThemeSwitcherTextProps> =
    ({}) => {
        ...
        return (
            <button
                className="rounded-lg bg-gray-light-3 dark:bg-gray-dark-3 px-4 py-2 flex flex-row"
                onClick={toggleTheme}
            >
                <div className="mr-2">
                    <span className="dark:hidden text-gray-light-12 text-sm align-middle">
                        Light
                    </span>
                    <span className="hidden dark:inline-block text-gray-dark-12 text-sm align-middle">
                        Dark
                    </span>
                </div>
                <div className="">
                    <svg
                        ...
                        className="fill-gray-light-12 dark:hidden align-middle"
                    >
                        <path
                            fillRule="evenodd"
                            clipRule="evenodd"
                    ...
                    <svg
                        ...
                        viewBox="0 0 16 16"
                        xmlns="http://www.w3.org/2000/svg"
                        className="hidden fill-gray-dark-12 dark:inline-block align-middle"
                    >
                        <path
                            fillRule="evenodd"
                            clipRule="evenodd"
...
export default ButtonThemeSwitcherText;
