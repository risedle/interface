...
export type LeveragedTokenDailyData = {
    timestamp: string;
...
export type LeveragedTokenTimeframeData = {
    ...
    oldestNAV: number;
    change: number;
    data: Array<LeveragedTokenDailyData>;
};

function filterOutSameNAV(data: Array<LeveragedTokenDailyData> | undefined): Array<LeveragedTokenDailyData> | undefined {
