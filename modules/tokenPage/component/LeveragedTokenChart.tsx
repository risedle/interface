        ...
        <div>
            ...
            <div className="flex flex-row space-x-4 px-4">
                <div className="flex w-[52px] flex-col space-y-2">
                    ...
                    {showNAVSkeleton && <div className="h-4 animate-pulse rounded-lg bg-gray-light-3 dark:bg-gray-dark-3"></div>}
            ...
            {/* Price chart */}
            <div className="z-0 mt-8 h-48 w-full">
                {showChartSkeleton && <div className="mb-2 h-48 animate-pulse bg-gray-light-3 dark:bg-gray-dark-3"></div>}
