...
const FormLoadingFailed: FunctionComponent<FormLoadingFailedProps> = ({}) => {
    return (
        <div className="mt-6">
            <div className="flex h-4 animate-pulse flex-row rounded-lg bg-gray-light-3 dark:bg-gray-dark-3"></div>

            <form className="mt-2 flex flex-col space-y-4">
                <div className="flex h-16 animate-pulse flex-row items-center justify-between rounded-lg bg-gray-light-3 p-4 dark:bg-gray-dark-3"></div>
                <div className="flex h-4 animate-pulse flex-row rounded-lg bg-gray-light-3 dark:bg-gray-dark-3"></div>
                <div className="h-[80px] border-b border-dashed border-gray-light-5 pt-4 pb-8 dark:border-gray-dark-5"></div>

                <button onClick={(e) => e.preventDefault()} className="flex w-full cursor-not-allowed flex-row items-center justify-center space-x-2 rounded-full border border-gray-light-4 bg-gray-light-2 py-[11px] px-4 text-center text-sm font-semibold leading-4 tracking-[-0.02em] text-blue-dark-1 dark:border-gray-dark-4 dark:bg-gray-dark-2 dark:text-blue-light-1">
