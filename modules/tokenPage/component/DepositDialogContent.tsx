...
/**
 * DepositDialogContentProps is a React Component properties that passed to React Component DepositDialogContent
 */
type DepositDialogContentProps = {
    chainID: number;
    address: string;
};

/**
 * DepositDialogContent is just yet another react component
 *
 * @link https://fettblog.eu/typescript-react/components/#functional-components
 */
const DepositDialogContent: FunctionComponent<DepositDialogContentProps> = ({ chainID, address }) => {
    // Global states
