...
/**
 * MintDialogContentProps is a React Component properties that passed to React Component MintDialogContent
 */
type MintDialogContentProps = {
    chainID: number;
    address: string;
};

/**
 * MintDialogContent is just yet another react component
 *
 * @link https://fettblog.eu/typescript-react/components/#functional-components
 */
const MintDialogContent: FunctionComponent<MintDialogContentProps> = ({ chainID, address }) => {
    // Global states
        ...
        <div>
            ...
            {showMintFormOrMaxCap && (
                <div>
                    ...
                    {/* Show mint input */}
                    {showMintForm && <MintForm chainID={chainID} address={address} />}
                </div>
            )}
        </div>
    );
...
export default MintDialogContent;
