...
/**
 * BackgroundDotsProps is a React Component properties that passed to React Component BackgroundDots
 */
type BackgroundDotsProps = {};

/**
 * BackgroundDots is just yet another react component
 *
 * @link https://fettblog.eu/typescript-react/components/#functional-components
 */
const BackgroundDots: FunctionComponent<BackgroundDotsProps> = ({}) => {
    return (
        <>
