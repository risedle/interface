...
import { MintState } from "../../../components/v1/MarketDetailPage/States";
...
import { useTotalAvailableCash } from "../../../components/v1/swr/useTotalAvailableCash";
...
const MintForm: FunctionComponent<MintFormProps> = ({ chainID, address }) => {
    // Global states
    const { chain, account, signer } = useWalletContext();
