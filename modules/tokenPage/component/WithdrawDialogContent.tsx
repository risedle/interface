...
/**
 * WithdrawDialogContentProps is a React Component properties that passed to React Component WithdrawDialogContent
 */
type WithdrawDialogContentProps = {
    chainID: number;
    address: string;
};

/**
 * WithdrawDialogContent is just yet another react component
 *
 * @link https://fettblog.eu/typescript-react/components/#functional-components
 */
const WithdrawDialogContent: FunctionComponent<WithdrawDialogContentProps> = ({ chainID, address }) => {
    // Global states
