        ...
        <InformationCard>
            ...
            <div className="flex flex-col space-y-6">
                ...
                <div className="flex flex-row justify-between">
                    ...
                    <a href={getEtherscanAddressURL(chainID === customChains.bsc.id ? customChains.bsc : Chains.arbitrumOne, address)} target="_blank" rel="noopener noreferrer" className="font-ibm text-sm font-semibold leading-4 tracking-[-.02em] text-gray-light-12 dark:text-gray-dark-12">
