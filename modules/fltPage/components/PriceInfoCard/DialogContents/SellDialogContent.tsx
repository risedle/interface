...
import { ApprovalState } from "../../../../tokenPage/component/States";
import FormLoading from "../Placeholder/FormLoading";
import FormLoadingFailed from "../Placeholder/FormLoadingFailed";
import RedeemForm from "./SellForm";

/**
 * SellDialogContentProps is a React Component properties that passed to React Component SellDialogContent
 */
type RedeemProps = {
    chainID: number;
    address: string;
...
/**
 * SellDialogContent is just yet another react component
 *
 * @link https://fettblog.eu/typescript-react/components/#functional-components
 */
const SellDialogContent: FunctionComponent<RedeemProps> = ({ chainID, address }) => {
    // Global states
