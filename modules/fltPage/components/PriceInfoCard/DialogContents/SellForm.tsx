...
import { RedeemState } from "../../../../tokenPage/component/States";
import FormLoading from "../Placeholder/FormLoading";
import FormLoadingFailed from "../Placeholder/FormLoadingFailed";

/**
 * SellFormProps is a React Component properties that passed to React Component SellForm
 */
type SellFormProps = {
    chainID: number;
    address: string;
...
/**
 * SellForm is just yet another react component
 *
 * @link https://fettblog.eu/typescript-react/components/#functional-components
 */
const SellForm: FunctionComponent<SellFormProps> = ({ chainID, address }) => {
    // Global states
