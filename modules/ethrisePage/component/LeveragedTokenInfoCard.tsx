...
import { DEFAULT_CHAIN, formatAddress, getEtherscanAddressURL, useWalletContext } from "../../../components/v1/Wallet";
 ...
 */
const LeveragedTokenInfoCard: FunctionComponent<LeveragedTokenInfoCardProps> = ({ address }) => {
