...
const Navigation: FunctionComponent<NavigationProps> = ({}) => {
    return (
        <div className="flex-column flex items-center gap-[44px] py-[16px] px-[192px]">
            <LogoV2 />
            ...
            <div className="flex flex-row items-start gap-[8px]">
                {/* Search Bar */}
                <div className="flex flex-row items-center gap-[90px] rounded-full bg-light-neutral-subtle/10 p-[8px] pl-[16px]">
                    {/* Input Box Wrapper */}
                    ...
                    <div className="flex flex-row items-start gap-[4px]">
                        <div className="flex h-[24px] w-[24px] items-center justify-center gap-[10px] rounded-[8px] bg-dark-background-elevated p-[8px]">
