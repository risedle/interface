...
const LogoV2: FunctionComponent<LogoV2Props> = ({ variant = "default" }) => {
    return (
        <div className="flex h-[24px] w-[83px] flex-row items-center gap-[7px]">
            <svg width="24" height="18" viewBox="0 0 24 18" fill="none" xmlns="http://www.w3.org/2000/svg" className="inline-block fill-dark-neutral-primary">
                <path
                    ...
                    fill={variant === "default" ? "#FCFDFF" : "#2B2E3F"}
                />
            </svg>
            <p className={`heading-h6 text-dark-neutral-primary ${variant === "default" || "text-dark-neutral-subtle"}`}>Risedle</p>
        </div>
    );
};
